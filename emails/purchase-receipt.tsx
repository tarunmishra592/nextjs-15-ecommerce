...
import { currency_formate } from '@/lib/utils'
              ...
              <Section>
                <Row>
                  ...
                  <Column>
                    ...
                    <Text className='mt-0 mr-4'>
                      {currency_formate(order.totalPrice)}
                    </Text>
                  </Column>
                </Row>
              </Section>
                ...
                {order.items.map((item) => (
                  <Row key={item.product} className='mt-8'>
                    ...
                    <Column align='right' className='align-top'>
                      <Text className='m-0 '>{currency_formate(item.price)}</Text>
                    </Column>
                  </Row>
                ))}
                {[
                  ...
                  <Row key={name} className='py-1'>
                    ...
                    <Column align='right' width={70} className='align-top'>
                      <Text className='m-0'>{currency_formate(price)}</Text>
                    </Column>
                  </Row>
                ))}
              </Section>
