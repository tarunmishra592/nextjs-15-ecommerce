...
import { createUpdateReview, getReviewByProductId, getReviews } from '@/lib/actions/reviw-actions'
import { ReviewFieldSchema } from '@/lib/validator'
...
export default function ReviewList({userId, product }: {
  ...
  type CustomerReview = z.infer<typeof ReviewFieldSchema>
  const form = useForm<CustomerReview>({
    resolver: zodResolver(ReviewFieldSchema),
