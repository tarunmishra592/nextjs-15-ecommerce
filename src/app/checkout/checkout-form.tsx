...
import { AVAILABLE_DELIVERY_DATES, AVAILABLE_PAYMENT_METHODS, DEFAULT_PAYMENT_METHOD } from '@/lib/constant'
              ...
              <Card className='hidden md:block '>
                <CardContent className='p-4 flex flex-col md:flex-row justify-between items-center gap-3'>
                  ...
                  <div className='flex-1'>
                    ...
                    <p className='text-xs'>
                      {' '}
                      By placing your order, you agree to <Link href='/page/privacy-policy'>
                        privacy notice
                      </Link> and
